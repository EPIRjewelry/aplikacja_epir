  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-4xl flex-col items-center px-6 text-center md:px-10">
        <p className="kazka-editorial-label mb-5 text-[rgb(var(--color-primary))]/80">
          KAZKA
        </p>
        <blockquote
          id="kazka-manifesto-heading"
          className="max-w-[45ch] font-serif text-2xl italic leading-[1.6] text-[rgb(var(--color-primary))] md:text-4xl"
        >
