/**
 * Buduje kanoniczny URL storefrontu Kazka.
 * Hydrogen <Seo> (deprecated) brał domenę główną Shopify (epirbizuteria.pl);
 * getSeoMeta wymaga jawnego `url` z subdomeną kazka.epirbizuteria.pl.
 */
