...
export const meta: MetaFunction<typeof loader> = ({data}) =>
  getSeoMeta({
    ...
    description: 'Wyszukaj biżuterię w kolekcji Kazka EPIR Art Jewellery.',
  ...
  return (
    <div className="mx-auto mt-12 max-w-7xl px-6 pb-12 md:mt-16 md:px-8 lg:px-12">
      ...
      <form method="get" action="/search" className="mb-8 flex flex-wrap gap-2">
        ...
        <button
          type="submit"
          className="rounded-md bg-[rgb(var(--color-primary))] px-4 py-2 text-sm font-medium text-[rgb(var(--color-contrast))] transition-colors hover:bg-[rgb(var(--color-primary))]/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-[rgb(var(--color-accent))] focus-visible:outline-offset-2"
        >
          Szukaj
        </button>
      </form>
