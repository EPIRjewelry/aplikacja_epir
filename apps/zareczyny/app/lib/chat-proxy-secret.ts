const KEYS = ['EPIR_CHAT_SHARED_SECRET', 'CHAT_SHARED_SECRET', 'X-EPIR-SHARED-SECRET'] as const;
 ...
 */
export function getEpirChatSharedSecret(env: Record<string, unknown> | undefined): string | undefined {
