...
| `Blender_Assist/` (osobne repo u operatora) | CAD, packshot, Blender MCP | Tylko IDE + Blender |
...
Szablon: [`epir.code-workspace`](../epir.code-workspace) w rootie tego repo — zakłada sąsiednie katalogi `../epir_analityc` i `../Blender_Assist`.
...
[`EPIR_DATA_FLOW_MAP.md`](EPIR_DATA_FLOW_MAP.md) — pixel, batch, Iceberg, `internal-dashboard`, granica do `epir_analityc`.
