...
export type LayoutProps<TCart = unknown> = {
  ...
  cart?: TCart;
  /** When set, replaces the default footer entirely (e.g. storefront-specific legal + branding). */
  footer?: React.ReactNode;
  /** When set, replaces the default header entirely (e.g. storefront-specific navigation). */
  renderHeader?: (props: {
    brandName: string;
    collections: NavCollection[];
    cartQuantity: number;
            ...
            <div className="flex flex-wrap gap-8 md:gap-12">
              <div>
                ...
                <ul className="flex flex-col gap-2 text-sm">
                  ...
                  <li>
                    <Link to="/chat" className="hover:underline underline-offset-4">
                      Czat
                    </Link>
                  </li>
