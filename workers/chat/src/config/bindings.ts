...
export interface Env {
  ...
  /**
   * AI Worker - REMOVED. Main worker uses ai-client.ts (direct Groq).
   * Per Cloudflare architecture plan: simplify to 3 workers.
   */
  ...
  /**
   * AI Gateway - gdy ustawione, requesty Groq idą przez gateway (cache, analytics, fallback)
   * Set in: wrangler.toml [vars]
   */
