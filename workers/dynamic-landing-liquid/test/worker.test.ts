    ...
    nodes: [
      {
        ...
        featuredImage: {url: 'https://cdn.shopify.com/x.png', altText: 't'},
      ...
      },
      {
        ...
        featuredImage: {url: 'https://cdn.shopify.com/y.png', altText: 'k'},
...
describe('dynamic-landing-liquid worker (Ads host)', () => {
  it('renders editorial forest_premium landing with product strip and process', async () => {
    ...
    expect(html).toContain('Rzemiosło premium z dolnośląskiego lasu');
  ...
  it('renders full organic_art editorial landing on l. host', async () => {
    ...
    expect(html).toContain('Niedoskonały z Założenia');
    expect(html).toContain('id="wspoltworzenie"');
    expect(html).toContain('Rozpocznij projektowanie online');
